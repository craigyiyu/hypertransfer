...
export default function AdmissionJourney({
  ...
  return (
    <div className="space-y-3 rounded-xl border border-border/60 bg-card/60 p-4">
      ...
      <MilestoneRow steps={admission.steps} currentIndex={admission.currentIndex} showCheck />
